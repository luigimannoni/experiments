...
// Sun
	...
	var planets = {
	  ...
	  speeds: [2, 3, 5, 10, 15, 30]
	}

	for (var i = 0; i <= planets.sizes.length; i++) {
	  ...
	  // Orbit
	  var orbit = new THREE.Line( new THREE.CircleGeometry( planets.distances[i], 64 ), new THREE.LineBasicMaterial( { color: 0xffffff, opacity: 0.3 } ) );
