...
export default class GpuProcessing extends Base {
  ...
  componentDidMount() {
    ...
    const box = BABYLON.MeshBuilder.CreateBox(
      "box",
      { size: 100, sideOrientation: BABYLON.Mesh.DOUBLESIDE },
      scene
    );
    ...
    material.setColor3(
      "target",
      new BABYLON.Color3.FromHexString(COLORS.TARGET)
    );
    ...
    document
      ...
      .addEventListener("change", injectImage, false);
