...
export default class ShaderLayering extends Base {
  ...
  componentDidMount() {
    ...
    renderPipeline.imageProcessing.vignetteColor = new BABYLON.Color4(
      0,
      0,
      0,
      1
    ...
    const material = {
      atmosphere: new BABYLON.ShaderMaterial(
        "atmosphere",
        scene,
        { vertex: "base", fragment: "earth" },
        {
      ...
      earth: new BABYLON.ShaderMaterial(
        "earth",
        scene,
        { vertex: "base", fragment: "earth" },
        {
    ...
    const textures = {
      ...
      color2: new BABYLON.Texture(
        "/assets/textures/earth/earth-night.jpg",
        scene
      ),
      specular: new BABYLON.Texture(
        "/assets/textures/earth/earth-specular.jpg",
        scene
      ),
      normal: new BABYLON.Texture(
        "/assets/textures/earth/earth-normal.jpg",
        scene
      ),
      ...
      cloudsTransparency: new BABYLON.Texture(
        "/assets/textures/earth/clouds-transparency.png",
        scene
      ),
    };
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture(
      "/assets/skyboxes/bluenebula1024",
      scene,
      loadExts
    );
